...
(* OASIS_START *)
(* DO NOT EDIT (digest: cf6d4af7c5df4bccffcb53d907657e61) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("./main.native", []))];
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "build Unix userspace bindings";
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "xen-gnt";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "xen_gnt_unix";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = ["gntshr_stubs.c"; "gnttab_stubs.c"];
                      bs_data_files = [];
                      bs_ccopt =
                        [
                      ...
                      bs_cclib =
                        [
                           (OASISExpr.EBool true,
                             ["-L/usr/lib/xen-4.2/lib"; "-lxenctrl"])
                        ];
                      bs_dlllib = [(OASISExpr.EBool true, [])];
                      bs_dllpath = [(OASISExpr.EBool true, [])];
                   ...
                   {
                      lib_modules = ["Gnt_dummy"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "xen_gnt";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "xen_gnt";
                           InternalLibrary "xen_gnt_unix";
                   ...
                   {exec_custom = false; exec_main_is = "test_gntshr.ml"});
               Executable
                 ({
                     cs_name = "linking";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      bs_byteopt = [(OASISExpr.EBool true, [])];
                      bs_nativeopt =
                        [(OASISExpr.EBool true, ["-dontlink"; "unix"])]
                   },
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title =
                        "Grant table bindings' documentation and API reference";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "T\150W\028\182\189\137\170o\215I\195\031\196\024E";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
